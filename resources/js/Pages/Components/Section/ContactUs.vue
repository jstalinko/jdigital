<template>
  <div id="contactSection">
    <section class="bg-gray-100 dark:bg-[#102A43] dark:text-[#BCCCDC] py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-200 mx-auto">
        ...
        <div class="mt-10">
          <form class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8" @submit.prevent="handleContactSubmit">
            <div>
              <label for="first_name" class="block text-sm font-medium text-gray-700 dark:text-gray-100">Nama Depan</label>
              <div class="mt-1">
                <input type="text" id="first_name" name="first_name" autocomplete="given-name"
                  class="py-3 px-4 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-2 border-gray-300 dark:border-gray-600 dark:bg-transparent rounded-md"
                  v-model="firstName">
              </div>
            </div>
            <div>
              <label for="last_name" class="block text-sm font-medium text-gray-700 dark:text-gray-100">Nama Belakang</label>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2">
              <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-100">No. HP</label>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2">
              <label for="subject" class="block text-sm font-medium text-gray-700 dark:text-gray-100">Subjek</label>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2">
              <label for="message" class="block text-sm font-medium text-gray-700 dark:text-gray-100">Pesan</label>
              <div class="mt-1">
